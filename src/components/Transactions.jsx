...
const Transaction = ({tx})=> (
    <div className="flex justify-between items-center border border-[#476ec2] text-gray-400 w-full shadow-xl shadow-black rounded-md overflow-hidden bg-gray-800 my-2 p-3">
        ...
        <div>
            ...
            <small className='flex justify-start items-center'>
                ...
                <a className='text-blue-500 mr-2' href="#" target="_blank">0x312312312</a>
                <MdOpenInNew />
            </small>
        </div>
